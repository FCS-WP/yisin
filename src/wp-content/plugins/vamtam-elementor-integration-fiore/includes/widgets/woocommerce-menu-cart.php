...
function update_controls_style_tab_cart_section( $controls_manager, $widget ) {
	...
	\Vamtam_Elementor_Utils::add_control_options( $controls_manager, $widget, 'remove_item_button_color', [
		'selectors' => [
			'{{WRAPPER}} .vamtam-remove-product svg' => 'color: var(--remove-item-button-color);fill: currentColor;',
			'{{WRAPPER}} .vamtam-remove-product svg :is(g, path)' => 'color: inherit;fill: inherit;',
		]
	] );
	...
	\Vamtam_Elementor_Utils::add_control_options( $controls_manager, $widget, 'remove_item_button_hover_color', [
		'selectors' => [
			'{{WRAPPER}} .vamtam-remove-product svg:hover' => 'color: var(--remove-item-button-hover-color);fill: currentColor;',
			'{{WRAPPER}} .vamtam-remove-product svg:hover :is(g, path)' => 'color: inherit;fill: inherit;',
		]
	] );
}
// Style - Cart section
